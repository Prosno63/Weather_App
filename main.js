const key = 'b10470a1ffd080a742ca78dc94f1200e';
...
function getWeatherDefault(url){
    // fetch('https://api.openweathermap.org/data/2.5/forecast?q='+input.value+ '&appid=b10470a1ffd080a742ca78dc94f1200e&units=metric') 
    fetch(url)
